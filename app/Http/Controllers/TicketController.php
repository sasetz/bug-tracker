...
class TicketController extends Controller
{
    ...
    /**
     * Method for searching and filtering tickets in the project.
     *
     ...
     * @throws AuthorizationException
     */
    public function search(SearchTicketRequest $request, Project $project): TicketResource
    {
        ...
        return new TicketResource($tickets->paginate(15));
    }
}
